...
parser.add_argument(
    '--dataset', type=str, default='100_envAform',
    help="Dataset name"
)


parser.add_argument(
    '--model', default='FSTKGC', type=str,
    help="Model Name"
)
parser.add_argument(
...
parser.add_argument(
    '--time_reg', default=0.0001, type=float,
...
def learn(model=args.model,
    ...
    model = {
        'FSTKGC': FSTKGC(sizes, rank, no_time_emb=args.no_time_emb)
    }[model]
    model = model.cuda()
